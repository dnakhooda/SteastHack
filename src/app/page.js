    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="text-center">
          <h2 className="text-5xl font-bold mb-6 text-black">Discover Events in Stetson East!</h2>
          ...
          <div className="mt-8">
            {activeTab === 'upcoming' && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Event Cards */}
                {[1, 2, 3].map((event) => (
                  <div key={event} className="bg-white rounded-lg overflow-hidden shadow-lg border border-[#D41B2C]">
