      ...
      <div className="container mx-auto px-0 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="space-x-8">
            <Link
              href="/"
              className="text-white hover:text-white transition-all duration-300 text-lg font-medium tracking-wide px-4 py-2 rounded-lg hover:-translate-y-1.5 hover:scale-107 inline-block font-['Lexend']"
            >
              Home
            </Link>
            <Link
